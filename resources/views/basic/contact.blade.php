            ...
            <div class="col-md-6 w3_agileits_contact_grid_left">
                ...
                <div class="agileits_w3layouts_map_pos">
                    <div class="agileits_w3layouts_map_pos1">
                        <h3>Contact Info</h3>
                        <p>
                            M/s. MaitriNutra Foods,
                            # 219 Ground Floor,
                            5th cross, 1st Stage,2nd Main KHB Colony,
                            Near Max Muller School,Basaveshwara Nagar,Bangalore – 560079
                        </p>
                        <ul class="wthree_contact_info_address">
                            <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">info@mahamillet.com</a></li>
                            <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">mahamillet@gmail.com</a></li>
                            <li><i class="fa fa-phone" aria-hidden="true"></i>7676412359</li>
                            <li><i class="fa fa-phone" aria-hidden="true"></i>9620938244</li>
                            <li><i class="fa fa-phone" aria-hidden="true"></i>9538511208</li>
                        </ul>
